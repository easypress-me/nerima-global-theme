				...
				<div class="container<?php echo ( $footer_width == 'wide' ) ? ' wide' : ''; ?>">
					<div class="row flex-items-xs-middle">
						<div class="col-xs-12 text-xs-left">
							<img src="<?php echo get_stylesheet_directory_uri() ?>/images/logo_b.png" class="footer-logo" width="126px" height="auto">
							<p>nerima9(kansei) | business number : 0112-01-020451 <span class="pc-br"></span>Tel : +81-80-3306-8282 | Address : 165-0033 東京都 中野区 若宮 3-28-12</p>
							<p class="copy">Copyright © NERIMA9 2020. All rights reserved.</p>
							<img class="footer-right-img" src="<?php echo get_stylesheet_directory_uri() ?>/images/footer-right-img.png">
						</div>
					</div>
				</div>
			</div>
...
<!-- <div class="btn-chat-kakao">
	<a href="http://pf.kakao.com/_WxfxjxkT/chat" target="_blank" class="kakao1" title="" data-hasqtip="0" aria-describedby="qtip-0"></a>
</div> -->
