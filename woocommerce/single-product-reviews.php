...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews"><?php esc_html_e( 'No reviews yet.', 'amely' ); ?></p>
			...
			<div id="review_form">
				...
				$comment_form = array(
					'title_reply'         => have_comments() ? esc_html__( 'Add a review',
						'amely' ) : sprintf( __( 'Be the first to review &ldquo;%s&rdquo;', 'amely' ),
						get_the_title() ),
					...
					'label_submit'        => esc_html__( 'Submit Review', 'amely' ),
					'logged_in_as'        => '',
					'comment_field'       => '',
				);
				...
				if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
					$comment_form['comment_field'] = '<div class="comment-form-rating"><label for="rating">' . esc_html__( 'Rating',
				...
				$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment"></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required placeholder="' . esc_html__( 'Please write a review *',
						'amely' ) . '"></textarea></p>';
	...
	<?php else : ?>
		...
		<p class="woocommerce-verification-required"><?php esc_html_e( 'Login is required to leave a review.',
				'amely' ); ?></p>
