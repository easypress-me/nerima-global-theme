...
<p class="widget_minicart_title"><?php esc_html_e( 'Cart', 'amely' ); ?>
	...
	<span class="undo">
						<?php esc_html_e( 'Deleted item.', 'amely' ) ?>
		<a href="#"><?php esc_html_e( 'Cancel', 'amely' ); ?></a>
					</span>
</p>
<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">

	<li class="woocommerce-mini-cart__empty-message empty<?php echo WC()->cart->is_empty() ? '' : ' hidden'; ?>"><?php esc_html_e( 'Empty Cart.',
			'amely' ); ?></li>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="woocommerce-mini-cart__total total"><strong><?php esc_html_e( 'Total', 'amely' ); ?>
