...
$classes[] = Amely_Helper::get_grid_item_class( array(
		'xs' => 2,
		'sm' => 2,
		'md' => 4,
		'lg' => 4,
...
<div <?php post_class( $classes ); ?>>
	...
	<div class="product-thumb" onclick="location.href='<?php echo get_permalink( get_the_ID(), $leavename = false ); ?>'">
		<?php
		...
		?>
		<div class="product-image" style="background-image:url(<?php echo get_the_post_thumbnail_url( get_the_ID(), $size = 'large' ); ?>);"></div>
		<div
	...
	<div class="product-info">
		...
		foreach(get_the_terms( $post->ID, 'product_cat' ) as $cd) {
			break;
		}
		echo '<span class="cate">'.$cd->name.'</span>';
		/**
