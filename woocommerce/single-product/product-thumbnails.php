...
if ( $attachment_ids && has_post_thumbnail() ) { ?>
	<div class="thumbnails thumbnails-slider"
		...
		if ( $product_page_layout != 'sticky' && $product_page_layout != 'sticky-fullwidth' ) {
			...
			// $main_attachment_id = get_field('com_image',get_the_ID())['ID'];

			// print_r(get_field('com_image',get_the_ID()));
	        ...
	        // $html .= wp_get_attachment_image( $main_attachment_id, apply_filters( 'amely_single_product_large_thumbnail_size', $size ), false, $attributes );
